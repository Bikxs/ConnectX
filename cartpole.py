...
if __name__ == '__main__':
    ...
    """
    # print(f'Action Spec: {suite_gym.load(env_name).action_spec()}')
    ...
    print(f'Observation Spec: {train_env.time_step_spec().observation}')
    print(f'Reward Spec: {train_env.time_step_spec().reward}')
    ...
    print(f'Data Spec: {agent.collect_data_spec}')
